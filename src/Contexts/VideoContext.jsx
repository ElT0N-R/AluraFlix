...
export const VideoProvider = ({ children }) => {
  const [videos, setVideos] = useState([
    { id: 1, categoria: "Comédia", img: "/path/to/image1.jpg", descricao: "Vídeo engraçado", titulo: "Comédia 1" },
    { id: 2, categoria: "Drama", img: "/path/to/image2.jpg", descricao: "Um drama emocionante", titulo: "Drama 1" }
  ]);
